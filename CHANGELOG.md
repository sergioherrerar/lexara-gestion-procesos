...
## 2026-08-16
- Ajustes al informe de Famisanar: el Excel se actualizó a la última plantilla (se quitó "Fecha Terminación", se corrió "Demandado" justo después de "Demandante", y se agregaron Enlace Proceso/No. Contrato/Link Contrato al final); la carta en PDF cambió de columnas a las que se confirmaron al final: Número corto, Naturaleza del Proceso, Despacho (junto con el No. de despacho) e Histórico.
