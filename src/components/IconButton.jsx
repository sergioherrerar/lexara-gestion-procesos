...
export const ICONS = {
  ...
  // Lupa — buscar (ej. "Buscar y vincular carpeta" en Procesos), para no
  // confundirse con el ícono de "Abrir enlace" (que usa la flecha "open").
  search: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  // Bocina — LexIA leyendo en voz alta (2026-09-24, pedido explícito del usuario).
  volumeOn: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
