...
export const ICONS = {
  ...
  // Globo de mensaje — compartir por WhatsApp (abre wa.me con el mensaje
  // ya redactado; el usuario elige a quién/qué grupo se lo manda desde su
  // propio WhatsApp). Ícono genérico, no el logo de WhatsApp.
  whatsapp: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
