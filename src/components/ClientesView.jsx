...
export default function ClientesView({ clientes, onOpenCliente, onDeleteCliente }){
  return (
    <div className="view">
      ...
      <div className="table-wrap">
        <table>
          <thead>
            <tr>
              <th>Razón social</th><th>NIT</th><th>Dirección</th><th>Teléfono</th><th>Correo</th><th>Entidad</th><th>Acciones</th>
            </tr>
          </thead>
          <tbody>
            {clientes.length ? clientes.map(c => (
              ...
              <tr><td colSpan={7}><div className="empty-state"><div className="mark" dangerouslySetInnerHTML={{__html: ICON_SVG}} />No hay clientes para mostrar.</div></td></tr>
            )}
          </tbody>
        </table>
      </div>
