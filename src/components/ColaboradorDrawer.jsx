...
export default function ColaboradorDrawer({ colaborador, liveMode, onClose, onSave, onDelete, saving }){
        ...
        <div className="drawer-body">
          <div className="field-section">
            <div className="field-grid">
              <div className="field"><label>Nombre</label><input type="text" value={form.Nombre} onChange={e => setField('Nombre', e.target.value)} /></div>
              <div className="field"><label>Correo</label><input type="text" value={form.Correo} onChange={e => setField('Correo', e.target.value)} /></div>
              <div className="field"><label>Tipo de identificación</label><input type="text" value={form.TipoIdentificacion} onChange={e => setField('TipoIdentificacion', e.target.value)} /></div>
              <div className="field"><label>Identificación</label><input type="text" value={form.Identificacion} onChange={e => setField('Identificacion', e.target.value)} /></div>
              <div className="field"><label>Teléfono</label><input type="text" value={form.Telefono} onChange={e => setField('Telefono', e.target.value)} /></div>
              <div className="field"><label>Dirección</label><input type="text" value={form.Direccion} onChange={e => setField('Direccion', e.target.value)} /></div>
              <div className="field">
                <label>Rol</label>
              ...
              <div className="field">
                <label>Activo</label>
                <select value={form.Activo ? "si" : "no"} onChange={e => setField('Activo', e.target.value === "si")}>
