...
// es siempre "Famisanar") — se recibe solo para que la firma sea igual a la
// del resto de generadores de Excel (ver FORMATOS_POR_ENTIDAD en InformesView.jsx).
export async function generarInformeFamisanarExcel(entidad, procesos){
